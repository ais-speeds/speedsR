#' Dataset 1/5. Fictitious Cycling Performance Dataset for Educational Use in the 'Data Wrangling: Cleaning and Tidying Raw Data' Lesson.
#'
...
"cycling_untidy_fictitious_data_1"